...
<body>
  ...
  <div class="form-group mt-2">
    ...
    <input type="text" name="location" id="ninNumber" class="form-control form-control-user" required>
  </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($nameResult->num_rows > 0) {
    ...
    echo "<script>window.location.href = 'add-borrower-group.php';</script>";
    exit;
  }
